...
-(void)createView{
    ...
    UILabel * label = [[UILabel alloc] initWithFrame:CGRectMake(0, 295, 320, 40)];
    ...
    _line = [[UIImageView alloc] initWithFrame:CGRectMake(40, 70, 240, 2)];
...
-(void)animation1
{
    ...
    [UIView animateWithDuration:2 animations:^{
         ...
         _line.frame = CGRectMake(40, 70+200, 240, 2);
    }completion:^(BOOL finished) {
        [UIView animateWithDuration:2 animations:^{
          _line.frame = CGRectMake(40, 70, 240, 2);
        }];
